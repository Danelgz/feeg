...
export const ICONS = {
  ...
  // Chat IA: dictado por voz, lectura en voz alta y envío de mensaje.
  mic: [
  ...
  volume2: [
    ...
    { tag: 'path', d: 'M18.36 5.64a9 9 0 0 1 0 12.73' },
  ],
  volumeX: [
    { tag: 'polygon', points: '11 5 6 9 2 9 2 15 6 15 11 19 11 5' },
  ...
  // Toggle de visibilidad de una rutina (pública/privada).
  eye: [
    { tag: 'path', d: 'M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z' },
    { tag: 'circle', cx: 12, cy: 12, r: 3 },
  ],
  eyeOff: [
    { tag: 'path', d: 'M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a18.5 18.5 0 0 1 5.06-5.94' },
