...
// Rampa de intensidad del mapa muscular: cuatro tintes del accent, de menos a más trabajado.
// Estaba hardcodeada dentro de MuscleMap.tsx, que es justo donde no debe vivir una escala de color
// — es la única de la app que codifica un DATO con color, así que si alguien cambia el accent en
// este archivo y la rampa se queda atrás, el mapa deja de pertenecer al resto de la interfaz.
// El último escalón es exactamente ACCENT, para que "muy alto" y el color de marca coincidan.
const HEAT = ['#c4f5e7', '#8dedce', '#57e5b6', ACCENT];
