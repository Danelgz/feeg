...
const InteractiveBodyMap = ({ counts = {}, onMuscleClick = () => {}, isDark = false }) => {
  ...
  const getColor = (intensity) => {
    ...
    if (intensity === 1) return isDark ? '#1a4d3c' : '#d1f2e8';
  ...
  const handleMuscleClick = (id) => {
    const muscleName = muscleMapping[id];
    if (muscleName) {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', width: '100%', maxWidth: '400px', margin: '0 auto' }}>
      <svg viewBox="0 0 660.46 1206.46" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto' }}>
        <defs>
        ...
        <g id="traps" onClick={() => handleMuscleClick('traps')} style={{ cursor: 'pointer', color: getColor(getIntensity('Espalda')), transition: 'color 0.3s' }}>
        ...
        <g id="calves" onClick={() => handleMuscleClick('calves')} style={{ cursor: 'pointer', color: getColor(getIntensity('Gemelos')), transition: 'color 0.3s' }}>
        ...
        <g id="hamstrings" onClick={() => handleMuscleClick('hamstrings')} style={{ cursor: 'pointer', color: getColor(getIntensity('Femoral')), transition: 'color 0.3s' }}>
        ...
        <g id="glutes" onClick={() => handleMuscleClick('glutes')} style={{ cursor: 'pointer', color: getColor(getIntensity('Glúteos')), transition: 'color 0.3s' }}>
        ...
        <g id="forearms" onClick={() => handleMuscleClick('forearms')} style={{ cursor: 'pointer', color: getColor(getIntensity('Antebrazos')), transition: 'color 0.3s' }}>
        ...
        <g id="triceps" onClick={() => handleMuscleClick('triceps')} style={{ cursor: 'pointer', color: getColor(getIntensity('Tríceps')), transition: 'color 0.3s' }}>
        ...
        <g id="lats" onClick={() => handleMuscleClick('lats')} style={{ cursor: 'pointer', color: getColor(getIntensity('Espalda')), transition: 'color 0.3s' }}>
        ...
        <g id="lowerback" onClick={() => handleMuscleClick('lowerback')} style={{ cursor: 'pointer', color: getColor(getIntensity('Espalda')), transition: 'color 0.3s' }}>
        ...
        <g id="traps-middle" onClick={() => handleMuscleClick('traps-middle')} style={{ cursor: 'pointer', color: getColor(getIntensity('Espalda')), transition: 'color 0.3s' }}>
        ...
        <g id="rear-shoulders" onClick={() => handleMuscleClick('rear-shoulders')} style={{ cursor: 'pointer', color: getColor(getIntensity('Hombros')), transition: 'color 0.3s' }}>
        ...
        <g id="body" style={{ pointerEvents: 'none' }}>
        ...
        <g id="joints" style={{ pointerEvents: 'none' }}>
           <ellipse cx="330.26" cy="491.77" rx="12.44" ry="12.3" fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3.52" />
        </g>
      </svg>
    </div>
  );
