...
/**
 * Foto real del ejercicio si existe en `public/exercises/{slug}.jpg`: intenta la imagen y cae al
 * avatar de iniciales+degradado (ExerciseThumb) si el archivo no está.
 *
