...
function BodyHeatmap({ muscleStats, t, isDark, isMobile }) {
  ...
  // Trazados detallados extraídos de react-body-highlighter
  const FRONT_PATHS = {
    Pecho: [
    ...
    Antebrazos: [
      "M216.03 723.17c-8.41-1.12-25.14-38.32-26.6-47.53-.16-1.11-.8-4.22.46-4.96s2.51.13 3.6 1.51c14.63 18.83 25.04 45.14 28.53 58.62a.81.81 0 01-.64.98q-2.54.49-5.35.38z",
      "M513.11 716.41q-2.15.54-4.5.11a.83.82-59.6 01-.66-.88q3.53-15.63 13.11-39.06 13.17-31.97 18.81-36.06c4.54-3.26 12.54 12.33 13.91 16.66q5.72 17.8 8.41 36.35c.08.57-.46.88-.93.68q-10.87-4.63-21.74-9.22-13.25-5.59-26.41-5.58z"
    ],
    Trapecio: [
      "M311.02 312.35c13.14-11.82 25.4-23.01 38.61-34.13a.98.98 0 011.53.48q12.36 31.11 23.95 62.25.29.77-.38 1.25-14.16 10.61-28.53 20.82c-4.38 3.08-9.4 1.27-14.11-.64q-10.37-4.27-20.82-8.41a.81.81 0 01-.48-.98c.17-5.04.14-13.62.23-20.64z",
      "M432.11 324.52a.83.82.6 01.81-.66q2.07-8.23 3.86-16.14c3.27-14.15 4.63-28.16 6.13-42.34a.97.97 0 011.75-.41q20.24 25.17 38.83 51.58.46.66-.11 1.15c-14.13 11.82-28.16 23.95-42.24 35.81-4.8 4.04-10.63 2.12-15.86.08q-1.12-.44-.82-1.39z"
    ],
    Oblicuos: [
      "M255.33 607.41c2.19 14.22 4.41 28.16 6.35 42.61q2.53 18.91 3.54 38.03.11 2.34-2.14 2.89c-8.91 2.15-26.31 4.31-35.06-2.15q-5.88-4.35-8.41-13.2-3.14-11.05-6.13-22.14a.83.83 0 01.44-.98q16.16-10.45 32.34-21.03c4.11-2.65 6.94-1.22 9.07 15.97z",
      "M463.11 602.35q15.88 10.61 31.95 21.03a.81.81 0 01.48.98c-1.57 6.41-3.14 12.83-4.63 19.14q-10.37 44.17-15.82 88.54-.16 1.34-1.53 1.08-8.12-1.57-16.14-3.12c-4.81-0.96-9.61-1.92-14.16-3.86a.83.83 0 01-.44-.98q8.25-45.16 16.14-90.35.68-3.86 3.12-13.11c1.23-4.62 1.94-3.41 5.03-9.35z"
    ],
    Cuello: [
      "M366.52 284.35c1.12 5.06 2.14 10.13 3.15 15.2q1.57 7.82 3.14 15.65.23 1.12-1.05 1.48c-8.41 2.37-16.82 4.63-25.27 6.35q-2.14.44-4.22-.88c-6.13-3.86-12.26-7.72-18.41-11.58-.61-.39-.44-1.12-.13-1.68 3.14-5.63 6.27-11.26 9.4-16.89 1.12-2.03 2.51-2.14 4.54-1.88 9.63 1.25 19.34 2.15 28.85-5.77z",
      "M401.35 282.11a.81.81 0 01.81.1c11.23 6.13 22.45 12.26 33.67 18.39.46.25.33.88.11 1.25q-3.12 5.61-6.24 11.24c-1.1 2.03-2.5 2.15-4.52 1.87q-15.61-2.14-31.18 5.76a.81.81 0 01-.81-.1c-1.12-5.06-2.14-10.13-3.15-15.2q-1.57-7.82-3.14-15.65c-.23-1.12.85-1.48 2.14-1.35q6.15.54 12.31 1.08z"
    ]
  };
  ...
  const BACK_PATHS = {
    ...
    Antebrazos: [
      "M893.11 724.35c-8.41-1.12-25.14-38.32-26.6-47.53-.16-1.11-.8-4.22.46-4.96s2.51.13 3.6 1.51c14.63 18.83 25.04 45.14 28.53 58.62a.81.81 0 01-.64.98q-2.54.49-5.35.38z",
      "M1268.35 712.11a.81.81 0 01.81.1c11.23 6.13 22.45 12.26 33.67 18.39.46.25.33.88.11 1.25q-3.12 5.61-6.24 11.24c-1.1 2.03-2.5 2.15-4.52 1.87q-15.61-2.14-31.18 5.76a.81.81 0 01-.81-.1c-1.12-5.06-2.14-10.13-3.15-15.2q-1.57-7.82-3.14-15.65c-.23-1.12.85-1.48 2.14-1.35q6.15.54 12.31 1.08z"
    ],
    Trapecio: [
      "M1066.52 284.35c1.12 5.06 2.14 10.13 3.15 15.2q1.57 7.82 3.14 15.65.23 1.12-1.05 1.48c-8.41 2.37-16.82 4.63-25.27 6.35q-2.14.44-4.22-.88c-6.13-3.86-12.26-7.72-18.41-11.58-.61-.39-.44-1.12-.13-1.68 3.14-5.63 6.27-11.26 9.4-16.89 1.12-2.03 2.51-2.14 4.54-1.88 9.63 1.25 19.34 2.15 28.85-5.77z",
      "M1101.35 282.11a.81.81 0 01.81.1c11.23 6.13 22.45 12.26 33.67 18.39.46.25.33.88.11 1.25q-3.12 5.61-6.24 11.24c-1.1 2.03-2.5 2.15-4.52 1.87q-15.61-2.14-31.18 5.76a.81.81 0 01-.81-.1c-1.12-5.06-2.14-10.13-3.15-15.2q-1.57-7.82-3.14-15.65c-.23-1.12.85-1.48 2.14-1.35q6.15.54 12.31 1.08z"
    ],
    Cuello: [
      "M1066.52 264.35c1.12 5.06 2.14 10.13 3.15 15.2q1.57 7.82 3.14 15.65.23 1.12-1.05 1.48c-8.41 2.37-16.82 4.63-25.27 6.35q-2.14.44-4.22-.88c-6.13-3.86-12.26-7.72-18.41-11.58-.61-.39-.44-1.12-.13-1.68 3.14-5.63 6.27-11.26 9.4-16.89 1.12-2.03 2.51-2.14 4.54-1.88 9.63 1.25 19.34 2.15 28.85-5.77z",
      "M1101.35 262.11a.81.81 0 01.81.1c11.23 6.13 22.45 12.26 33.67 18.39.46.25.33.88.11 1.25q-3.12 5.61-6.24 11.24c-1.1 2.03-2.5 2.15-4.52 1.87q-15.61-2.14-31.18 5.76a.81.81 0 01-.81-.1c-1.12-5.06-2.14-10.13-3.15-15.2q-1.57-7.82-3.14-15.65c-.23-1.12.85-1.48 2.14-1.35q6.15.54 12.31 1.08z"
    ]
  };

  // Silueta decorativa (no mapeada a entrenamientos)
  const DECORATIVE_PATHS = [
    ...
    // Manos frontales
    "M 165 680 c -5 -5 -15 -5 -20 0 c -5 5 -10 15 -5 25 c 5 10 15 20 25 15 c 5 -5 5 -15 0 -20 z",
    "M 575 680 c 5 -5 15 -5 20 0 c 5 5 10 15 5 25 c -5 10 -15 20 -25 15 c -5 -5 -5 -15 0 -20 z",
    // Pies frontales
    "M 240 1200 q -10 20 10 40 h 30 q 20 -20 10 -40 z",
    "M 440 1200 q -10 20 10 40 h 30 q 20 -20 10 -40 z",
    // Manos posteriores
    "M 850 680 c -5 -5 -15 -5 -20 0 c -5 5 -10 15 -5 25 c 5 10 15 20 25 15 c 5 -5 5 -15 0 -20 z",
    "M 1260 680 c 5 -5 15 -5 20 0 c 5 5 10 15 5 25 c -5 10 -15 20 -25 15 c -5 -5 -5 -15 0 -20 z",
    // Pies posteriores
    "M 920 1200 q -10 20 10 40 h 30 q 20 -20 10 -40 z",
    "M 1120 1200 q -10 20 10 40 h 30 q 20 -20 10 -40 z"
  ];
      ...
      <div style={{ 
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <svg width={isMobile ? "150" : "200"} height={isMobile ? "300" : "400"} viewBox="40 100 650 1250">
            {/* Silueta base decorativa */}
            {DECORATIVE_PATHS.filter((_, idx) => idx % 2 === 0 || idx < 2).map((p, i) => <path key={i} d={p} fill={silhouetteColor} />)}
            
            {/* Fondo de cuerpo base para diferenciar del fondo */}
            {Object.entries(FRONT_PATHS).map(([group, paths]) => 
              paths.map((p, i) => <path key={`base-${group}-${i}`} d={p} fill={bodyBaseColor} stroke={isDark ? "#000" : "#fff"} strokeWidth="0.2" />)
            )}

            {/* Grupos musculares frontales */}
            {Object.entries(FRONT_PATHS).map(([group, paths]) => {
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <svg width={isMobile ? "150" : "200"} height={isMobile ? "300" : "400"} viewBox="780 100 650 1250">
            ...
            {/* Fondo de cuerpo base */}
            {Object.entries(BACK_PATHS).map(([group, paths]) => 
              paths.map((p, i) => <path key={`base-back-${group}-${i}`} d={p} fill={bodyBaseColor} stroke={isDark ? "#000" : "#fff"} strokeWidth="0.2" />)
            )}
